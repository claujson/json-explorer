...
protected:
	...
	inline static const claujson::_Value _find = claujson::_Value( "find"sv);
	inline static const claujson::_Value _find_by_key = claujson::_Value( "find_by_key"sv);
	inline static const claujson::_Value _find_by_value = claujson::_Value( "find_by_value"sv); 
...
protected:
	...
	virtual void okOnButtonClick(wxCommandEvent& event) {
		...
		try {
			claujson::Document document_key;
...
private:
	...
	inline static claujson::_Value _str_op = claujson::_Value( "op"sv);
private:
...
public:
	...
	void FirstFrame() {
		isMain = true;
		mode = 1;
		global = wiz::SmartPtr2<claujson::StructuredPtr>(new claujson::StructuredPtr(claujson::Array::Make()));
		now = *global;
	}
